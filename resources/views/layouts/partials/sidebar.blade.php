<div class="sidebar-wrapper">
    ...
    <div class="logo-wrapper">
        <a href="{{ route('home') }}"><img class="img-fluid for-light" src="{{ asset('assets/images/logo/logoweb.png') }}" alt="logo TNI AD" style="width: 100px; object-fit: cover;"><img class="img-fluid for-dark" src="{{ asset('assets/images/logo/logowebdark.png') }}" alt="logowebsite" style="height: 100px; width: 200px; object-fit: cover;"></a>
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="book-open"></i><span>Update Data KPR</span></a>
                   <ul class="sidebar-submenu">
                       <li><a href="{{ route('admin.rekapdata.tahun') }}">Pertahun</a></li>
                        ...
                        <li><a href="{{ route('admin.detaildata.refreshsaldo') }}">Refresh Saldo</a></li>
                        <li><a href="{{ route('admin.detaildata.refreshpiutang') }}">Refresh Piutang</a></li>
                   </ul> 
                </li>
